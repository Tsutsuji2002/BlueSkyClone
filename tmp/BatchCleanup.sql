...
-- Safety: drop temp tables from any previous failed run
...
RAISERROR ('Found %d remote stub users.', 0, 1, @RemoteUserCount) WITH NOWAIT;
RAISERROR ('STEP 2: Batch deleting posts (50k at a time)...', 0, 1) WITH NOWAIT;
...
RAISERROR ('STEP 3: Shrinking database...', 0, 1) WITH NOWAIT;
