...
const AltTextModal: React.FC<AltTextModalProps> = ({ isOpen, onClose, imageUrl, initialAlt, onSave }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-end lg:items-center justify-center lg:p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white dark:bg-dark-surface rounded-t-3xl lg:rounded-3xl w-full lg:max-w-2xl overflow-hidden shadow-2xl animate-in fade-in slide-in-from-bottom-2 lg:zoom-in duration-200">
                {/* Header */}
