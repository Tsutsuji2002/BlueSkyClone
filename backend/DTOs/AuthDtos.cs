...
public record UserSettingDto(
    ...
    [property: JsonPropertyName("sortReplies")] string? SortReplies,
    bool? RequireAltText,
    ...
    [property: JsonPropertyName("defaultReplyRestriction")] string? DefaultReplyRestriction,
    [property: JsonPropertyName("defaultAllowQuotes")] bool? DefaultAllowQuotes,
    int? FontSize,
    bool? EnableTrending,
    bool? EnableDiscoverVideo,
    [property: JsonPropertyName("treeView")] bool? EnableTreeView,
    [property: JsonPropertyName("logoutVisibility")] bool? RequireLogoutVisibility,
    bool? LargerAltBadge,
    bool? ShowReplies,
    bool? ShowReposts,
    bool? ShowQuotePosts,
