...
public interface IChatService
{
    ...
    Task<MessageDto> SendMessageAsync(Guid userId, Guid conversationId, string? content, string? imageUrl = null, string? altText = null, Guid? replyToId = null, LinkPreviewDto? linkPreview = null);
